...
Время работы пирамидальной сортировки — O(nLogn) даже в худшем случае, что делает её более стабильной чем быстрая сортировка.
...
void HeapSort(int* a, int n)
	{
		for(int i = (n/2) - 1; i >= 0; i--) // начинаем с последнего узла 
				tripleswap(a,i,n); // переставляем в узел наибольший элемент.
